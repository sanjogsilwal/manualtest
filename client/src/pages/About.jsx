    ...
    <>
      <section className="page-header">
        <div className="container">
          ...
          <h1>About Us</h1>
          <p>LearnSpace - IOE Thapathali Campus</p>
        </div>
      </section>
      ...
      <main>
        <div className="container">
          <div className="about-content">
            ...
            <p><strong>LearnSpace</strong> is the official online repository of laboratory manuals, course tutorials and student-contributed notes for the departments of the Institute of Engineering, Thapathali Campus.</p>
